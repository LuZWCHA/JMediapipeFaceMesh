#include "top_nowandfuture_jmediapipe_FrameGrabber.h"

JNIEXPORT jlong JNICALL Java_top_nowandfuture_jmediapipe_FrameGrabber_createGrabber
(JNIEnv*, jobject) {
 ...
 * Signature: (I)Z
 */
JNIEXPORT jboolean JNICALL Java_top_nowandfuture_jmediapipe_FrameGrabber_open
 ...
 * Signature: ()Z
 */
JNIEXPORT jboolean JNICALL Java_top_nowandfuture_jmediapipe_FrameGrabber_close
 ...
 * Signature: ()[B
 */
JNIEXPORT jbyteArray JNICALL Java_top_nowandfuture_jmediapipe_FrameGrabber_readFrame
 ...
 * Signature: ()Z
 */
JNIEXPORT jboolean JNICALL Java_top_nowandfuture_jmediapipe_FrameGrabber_isOpened
(JNIEnv* env, jobject thisObj, jlong rf) {
	return ((cvcap::FrameGrabber*)rf)->isOpened() ? JNI_TRUE : JNI_FALSE;
}

JNIEXPORT jboolean JNICALL Java_top_nowandfuture_jmediapipe_FrameGrabber_set
...
JNIEXPORT jdouble JNICALL Java_top_nowandfuture_jmediapipe_FrameGrabber_get
